...
gui.add(directionalLight,'intensity').min(1).max(10).step(0.001).name("Light Intensity")
...
// Bias Controls
gui.add(directionalLight.shadow, 'normalBias').min(-0.01).max(0.05).step(0.001)

...
const floorColorTexture = textureLoader.load('./textures/rocky_trail_02_diff_1k.webp')
const floorARMTexture = textureLoader.load('./textures/rocky_trail_02_arm_1k.webp')
const floorNormalTexture = textureLoader.load('./textures/rocky_trail_02_nor_gl_1k.webp')
const floorDisplacementTexture = textureLoader.load('./textures/rocky_trail_02_disp_1k.webp')
...
const roofNormalTexture = textureLoader.load('./roof/roof_slates_02_arm_1k.webp')
...
// Gui Controls Floor
gui.add(floor.material, 'displacementScale').min(0).max(1).step(0.001).name('Desplazamiento del suelo')
gui.add(floor.material, 'displacementBias').min(0).max(1).step(0.001).name('Inclinación del suelo')
...
// Ambient light
const ambientLight = new THREE.AmbientLight('#69F9CC', 0.275)
scene.add(ambientLight)

// Directional light
const directionalLight = new THREE.DirectionalLight('#69F9CC', 1)
...
// Fog
scene.fog = new THREE.FogExp2('#03343F' , 0.1, 10)

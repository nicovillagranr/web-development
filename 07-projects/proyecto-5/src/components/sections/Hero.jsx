  ...
  return (
    <section className="relative min-h-screen flex items-center px-6 md:px-10 overflow-hidden">
      ...
      <div className="absolute inset-0">
        <div className="absolute top-[-15%] right-[-5%] w-[600px] h-[600px] bg-brand-warm/12 rounded-full blur-[150px]" />
        <div className="absolute bottom-[-10%] left-[-10%] w-[500px] h-[500px] bg-brand-accent/8 rounded-full blur-[120px]" />
        <div className="absolute top-[30%] left-[50%] w-[400px] h-[400px] bg-brand-600/40 rounded-full blur-[100px]" />
        {/* Sunset horizon line */}
        <div className="absolute bottom-[20%] left-0 right-0 h-px bg-gradient-to-r from-transparent via-brand-warm/20 to-transparent" />
      </div>

      {/* Vertical neon line */}
      <div className="absolute top-0 right-[22%] w-px h-full bg-gradient-to-b from-transparent via-brand-accent/15 to-transparent" />
      ...
      <div className="relative max-w-7xl mx-auto w-full z-10 pt-24 md:pt-0">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          <div className="lg:col-span-7">
            ...
            >
              <span className="inline-block text-brand-warm/80 text-xs font-body font-500 uppercase tracking-[0.3em] mb-6 border border-brand-warm/25 rounded-full px-4 py-1.5 shadow-[0_0_15px_rgba(255,45,149,0.1)]">
            ...
            >
              {HERO.headline}
              <span className="bg-gradient-to-r from-brand-warm via-brand-sunset to-brand-accent bg-clip-text text-transparent drop-shadow-[0_0_20px_rgba(255,45,149,0.3)]">
                {HERO.headlineAccent}
              </span>
            </motion.h1>
            ...
            >
              <HiCheckCircle className="text-brand-accent text-lg drop-shadow-[0_0_6px_rgba(0,229,255,0.5)]" />
          ...
          >
            <div className="relative w-80 h-80">
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="w-24 h-24 bg-gradient-to-br from-brand-warm/15 to-brand-accent/10 rounded-2xl rotate-45 backdrop-blur-sm border border-brand-warm/20 shadow-[0_0_30px_rgba(255,45,149,0.15)]" />
              </div>
              {/* Neon dots */}

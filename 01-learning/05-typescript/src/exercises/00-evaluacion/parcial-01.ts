...
export function tomar<Objeto, Llave extends keyof Objeto>(
  obj: Objeto,
  clave: Llave,
): Objeto[Llave] {
  return obj[clave];
...
export function columna<Objetos, Llave extends keyof Objetos>(
  arr: Objetos[],
  clave: Llave,
): Objetos[Llave][] {
...
export function maximoPor<Objeto extends Record<Clave, number>, Clave extends string>(
  arr: Objeto[],
  clave: Clave,
): Objeto | undefined {

...
export const weatherGradients = {
    ...
    clear: {
        ...
        night: "bg-[linear-gradient(150deg,_#0A1632_10%,_#102449_20%,_#173760_40%,_#1D4A74_100%)]",
    },
    ...
    cloudy: {
        light: {
            ...
            night: "bg-[linear-gradient(150deg,_#253447_0%,_#1F2D3F_10%,_#1A2635_40%,_#141E2B_100%)]",
        },
        medium: {
            day: "bg-[linear-gradient(150deg,_#62778C_0%,_#556A7E_10%,_#4A5F73_40%,_#3F5366_100%)]",
            night: "bg-[linear-gradient(150deg,_#1F2D3F_0%,_#192638_10%,_#152030_40%,_#101926_100%)]",
        },
        heavy: {
            day: "bg-[linear-gradient(150deg,_#566B7F_0%,_#4A5E72_10%,_#3F5366_40%,_#344758_100%)]",
            night: "bg-[linear-gradient(150deg,_#182536_0%,_#142030_10%,_#101929_40%,_#0C131F_100%)]",
        },
    },
    ...
    rain: {
        light: {
            ...
            night: "bg-[linear-gradient(150deg,_#112A46_0%,_#0E233C_10%,_#0A1C31_40%,_#071526_100%)]",
        },
        medium: {
            day: "bg-[linear-gradient(150deg,_#355E84_0%,_#2B5173_10%,_#23455F_40%,_#1B384D_100%)]",
            night: "bg-[linear-gradient(150deg,_#0D233B_0%,_#0A1D31_10%,_#081727_40%,_#06111D_100%)]",
        },
        heavy: {
            day: "bg-[linear-gradient(150deg,_#2C4F73_0%,_#244464_10%,_#1D3A56_40%,_#162D45_100%)]",
            night: "bg-[linear-gradient(150deg,_#091A2D_0%,_#071525_10%,_#05101D_40%,_#030B15_100%)]",
        },
    },
    ...
    snow: {
        light: {
            ...
            night: "bg-[linear-gradient(150deg,_#2C4563_0%,_#243A54_10%,_#1D3045_40%,_#162638_100%)]",
        },
        medium: {
            day: "bg-[linear-gradient(150deg,_#5F84A9_0%,_#51779B_10%,_#456A8C_40%,_#395D7E_100%)]",
            night: "bg-[linear-gradient(150deg,_#253C57_0%,_#1F334B_10%,_#192A3F_40%,_#132134_100%)]",
        },
        heavy: {
            day: "bg-[linear-gradient(150deg,_#53789E_0%,_#476D90_10%,_#3B6182_40%,_#315574_100%)]",
            night: "bg-[linear-gradient(150deg,_#1F344C_0%,_#1A2C40_10%,_#152436_40%,_#101C2B_100%)]",
        },
    },
    ...
    storm: {
        ...
        night: "bg-[linear-gradient(150deg,_#142339_0%,_#101C2D_10%,_#0C1623_40%,_#080F18_100%)]",
    },

    // Categoria: neblina/mist (sin intensidad).
    mist: {
        day: "bg-[linear-gradient(150deg,_#75899D_0%,_#687D90_10%,_#5B7082_40%,_#4E6374_100%)]",
        night: "bg-[linear-gradient(150deg,_#253446_0%,_#1F2C3B_10%,_#192532_40%,_#131D27_100%)]",
    },
};

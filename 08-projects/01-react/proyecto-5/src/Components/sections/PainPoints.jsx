...
export default function PainPoints() {
  return (
    <section className="py-24 md:py-32 px-6 md:px-10 relative">
      {/* Línea decorativa superior — gradiente desde transparent, pico en warm, transparent */}
      ...
      <div className="max-w-7xl mx-auto">
        {/* Header: tag y headline principal de la sección */}
        <AnimateOnScroll>
        ...
        {/* Grid de 3 cards — cada una entra con stagger de 0.12s */}
          ...
          {PAIN_POINTS.items.map((item, i) => (
            <AnimateOnScroll key={item.title} delay={i * 0.12}>
              <div className="group bg-brand-800/60 rounded-2xl border border-brand-warm/8 p-7 md:p-9 h-full hover:border-brand-warm/25 transition-all duration-500 relative overflow-hidden">
                {/* Glow de fondo en esquina superior derecha, se intensifica en hover */}
                ...
                {/* Icono de X rojo como indicador visual de problema */}

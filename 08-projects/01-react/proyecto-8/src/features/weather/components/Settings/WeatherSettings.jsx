...
const RETRY_BTN = "mt-3 rounded-xl px-3 py-2 bg-white/20 text-sm transition-colors hover:bg-white/30";
const ERROR_BANNER_BTN = "shrink-0 rounded-lg bg-white/20 px-2 py-1 transition-colors hover:bg-white/30";
            ...
            <div className="flex-1 pb-10 overflow-y-auto overscroll-contain no-scrollbar">
                ...
                {!weather && !!error && (
                    <article className="mx-4 mt-4 rounded-3xl backdrop-blur-xl bg-rose-500/15 border border-rose-300/40 p-4 text-white">
                        ...
                        <button type="button" onClick={() => retry?.()} className={RETRY_BTN}>
                            Reintentar
                        </button>
                    </article>
                )}

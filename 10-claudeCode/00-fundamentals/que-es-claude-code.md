...
## 8. Ejercicio de primer dia

1. Abre una terminal en cualquier proyecto tuyo.
2. Ejecuta `claude`.
3. Dile: "dame un resumen de este proyecto".
4. Luego: "busca todos los archivos .md que existan".
5. Observa como usa herramientas (Glob, Read) en lugar de solo responder texto.

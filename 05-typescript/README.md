...
**[HISTÓRICO] Antes del refuerzo: `exercise-02` drill 1 (`sumar`).** Al terminar el 7, volver a `exercise-01` drill 8 (debería caer solo), y de ahí al "Por qué" del E1 (`parcial-01.ts:169`). Estado de exercise-01: drills 1–7 APROBADOS; **drill 8 PAUSADO** a la espera de este refuerzo.

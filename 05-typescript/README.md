...
- `05-unions-narrowing/` — **01, 02 y 03 APROBADOS (03 completo, 29/29 tests).** 01 (antes 05) tipos literales y unions de literales; 02 (antes 07) narrowing con `typeof` y `undefined`. **03 (refuerzo, jun 2026)** — narrowing con objetos y `null`: surgió en el parcial (B3) que no tenía claras dos herramientas.
...
- Próximos: terminar `07-utility-types/` (exercise-06 drills 4–8; luego más utility types: Pick, Omit, Readonly...), antes de FASE 2 (React + TS).

    ...
    return (
        <footer className="bg-gray-900 text-gray-300 font-body">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 flex flex-col md:flex-row md:items-center md:justify-between gap-6">
                    ...
                    <div className="flex flex-col gap-2 md:items-end">
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <a href="#" aria-label="X" className="w-9 h-9 flex items-center justify-center rounded-full bg-gray-800 hover:bg-rose-500 transition-colors duration-200">
                                <svg className="w-4 h-4 text-white" fill="currentColor" viewBox="0 0 24 24"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
                            </a>
                            <a href="#" aria-label="YouTube" className="w-9 h-9 flex items-center justify-center rounded-full bg-gray-800 hover:bg-rose-500 transition-colors duration-200">
            ...
            <div className="bg-black">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex flex-col md:flex-row md:items-center md:justify-between gap-2 text-[12px] text-gray-500">
                    <p>© {new Date().getFullYear()} Trendy. Todos los derechos reservados.</p>
                    <p>Hecho con <span className="text-rose-500">♥</span> en Chile</p>
                </div>
            </div>

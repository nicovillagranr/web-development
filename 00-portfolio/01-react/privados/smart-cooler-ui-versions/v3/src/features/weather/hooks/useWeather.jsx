...
export function useWeather({
    ...
    // nowTick: timestamp truncado al inicio de la hora actual.
    // Se recalcula cada 60s pero React hace bail-out si el valor no cambió,
    // así el useMemo solo se invalida una vez por hora (cuando el bloque horario realmente cambia).
    ...
    // Reloj interno: cada 60s actualiza nowTick truncado a la hora.
    // Polling frecuente para no perder el cambio de hora, pero el valor solo
    // cambia una vez por hora → el useMemo solo se invalida cuando corresponde.
    useEffect(() => {

import MiningIcon from '../shared/icons/MiningIcon'
import EPPIcon from '../shared/icons/EPPIcon'
import HydraulicIcon from '../shared/icons/HydraulicIcon'
import EngineeringIcon from '../shared/icons/EngineeringIcon'
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
          {services.map((service, idx) => {
            ...
            return (
              <div
                key={idx}
                className="group bg-white rounded-2xl p-8 shadow-industrial hover:shadow-lg-industrial transition-shadow duration-300 cursor-pointer"
              >
                {/* Icon with background */}
                <div className="mb-6 inline-block">
                  <div
                    className={`w-16 h-16 rounded-xl bg-mgd-gray-light flex items-center justify-center group-hover:bg-mgd-orange/20 transition-colors ${service.color}`}
                  >
                ...
                {/* Content */}
                <h3 className="font-display font-bold text-xl mb-3 text-mgd-navy group-hover:text-mgd-orange transition-colors">
                  {service.title}
                </h3>

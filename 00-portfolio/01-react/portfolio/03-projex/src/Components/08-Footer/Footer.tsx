...
function Footer() {
    return (
        <footer
            className="w-full min-h-[15vh] bg-dark border-t border-white/10 flex flex-col items-center justify-center gap-4 px-8 sm:flex-row sm:justify-between sm:gap-0">

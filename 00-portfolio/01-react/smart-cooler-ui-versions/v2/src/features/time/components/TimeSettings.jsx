            ...
            <div className="flex-1 p-4 space-y-2">
                ...
                <div className="flex items-center justify-between px-4 h-14 rounded-xl bg-white/4 border border-white/6">
                    ...
                    <button
                        ...
                        className={`relative w-11 h-6 rounded-full transition-colors duration-200 ${autoTime ? "bg-green-500" : "bg-white/15"}`}
                    >
                        <span
                ...
                <div className="flex items-center justify-between px-4 h-14 rounded-xl bg-white/4 border border-white/6">
                    ...
                    <button
                        ...
                        className={`relative w-11 h-6 rounded-full transition-colors duration-200 ${is24hFormat ? "bg-green-500" : "bg-white/15"}`}
                    >
                        <span
